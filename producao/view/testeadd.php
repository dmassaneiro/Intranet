                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <form action="../../classes/controle/FichaTecnicaControle.php" method="POST">
                            ...
                            <div class="col-md-1">
                                <label>Número</label>
                                <input type="number" required="" name="numero" class="form-control" value="<?= $idd ?>">
                            </div>
                            <?php
                            ...
                            if ($idproduto == '28' || $idproduto == '29' || $idproduto == '30' || $idproduto == '31' ||
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="outro1" class="form-control">
                                </div>
                            <?php } ?>
                            <div class="col-md-5">
                            ...
                            <div class="col-md-3">
                                <label><br><br></label>
                                <button type="submit" name="addteste" class="btn btn-success">Adicionar</button>
                            </div>
                        </form>
                    </div>
                    <BR>
                                                    ...
                                                    <div class="col-md-12">
                                                        <form action="../../classes/controle/FichaTecnicaControle.php" method="post">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <label>Número</label>
                                                                    <input type="text" required="" name="numero" class="form-control" value="<?= $ve->getNumero() ?>">
                                                                </div>
                                                                <?php
                                                                if ($idproduto == '1' || $idproduto == '2' || $idproduto == '3' || $idproduto == '4' ||
                                                                $idproduto == '5' || $idproduto == '6' || $idproduto == '7' || $idproduto == '8' ||
                                                                ...
                                                                $idproduto == '50') {
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        ...
                                                                        <input type="text" name="valor" class="form-control" value="<?= $ve->getValor() ?>">
                                                                    </div>
                                                                    <?php
                                                                }
                                                                if ($idproduto == '28' || $idproduto == '29' || $idproduto == '30' || $idproduto == '31' ||
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <label><br><br></label>
                                                                    <button type="submit" name="editateste" class="btn btn-success">Editar</button>
                                                                </div>
                                                            </div>
                                                        </form>         
                                                    </div> 
